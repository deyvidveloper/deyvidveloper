...
- 🏥 **Sistema de Gestión de Atenciones Médicas** API REST  
  modular con validaciones, seguridad y arquitectura lista para integración frontend.  
  `Java 17 · Spring Boot · PostgreSQL · Spring Security · JWT · Roles`

- 🛏️ **Sistema de Reservas de Habitaciones** Backend  
  con control de acceso por roles, persistencia JPA y estructura MVC.  
