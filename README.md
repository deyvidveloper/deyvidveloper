<h1 align="center"><b>Hola, soy Deyvid Bustamante</b> <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"></h1>

<p align="center">
  <a href="https://github.com/DenverCoder1/readme-typing-svg">
    <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&color=00F7FF&size=22&center=true&vCenter=true&width=700&height=60&lines=Desarrollador+de+Software;Java+%7C+Spring+Boot+%7C+Spring+Security+%7C+JWT+%7C+MySQL;Buscando+experiencia+como+trainee;C%23+%7C+ASP.NET+Core+%7C+SQL+Server+%7C+React+%7C+Tailwind;Kotlin+%7C+Android+%7C+Jetpack+Compose">
  </a>
</p>
...
- 👕 **Sistema POS e Inventario - Urban Style** `ASP.NET Core (.NET 8) · React · Tailwind CSS · SQL Server · EF Core`  
  Solución Full Stack para gestión minorista con control de stock por variantes (tallas/colores), reportes en PDF/Excel y sistema de anulaciones con retorno de inventario.

- 🏥 **Sistema de Gestión de Atenciones Médicas** `Java 17 · Spring Boot · PostgreSQL · Spring Security · JWT · Roles`  
...
- **Frameworks y herramientas** ![Spring Boot](https://img.shields.io/badge/Spring_Boot-6DB33F?style=for-the-badge&logo=spring&logoColor=white)
